...
public class RegularExpressionTest {
	public static void main(String[] args) {
		...
		String[] patterns = {
								...
								"^[0-9가-힣]*",// 숫자 + 영어 소문자 1자 이상
								"^[A-Za-z]*",// 숫자 + 영어 소문자 1자 이상
								"\\s",		// 공백
								"\\S",		// 공백이 아닌 문자
								"\\d",		// 숫자
								"\\w",		// 숫자와 문자
		...
		String[] words = {"apple", "123한글", "123456",
						  "011", "hello", "홍길동", "1",
						  "Banana", "APPLE", "#",
						  "123abc", "011한글"};
		...
		String str = "이름 : 홍길동, 휴대폰 : 010-123-1001, 이메일 : hong@gmail.com";
